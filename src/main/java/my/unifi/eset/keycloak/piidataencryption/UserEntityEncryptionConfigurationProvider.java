...
public class UserEntityEncryptionConfigurationProvider implements UiTabProvider, UiTabProviderFactory<ComponentModel> {
    ...
    public void validateConfiguration(KeycloakSession session, RealmModel realm, ComponentModel model) throws ComponentValidationException {
        ...
        if (model.get("enable", false) && !providerActive) {
            throw new ComponentValidationException("User entity encryption cannot be enabled until EncryptedUserProvider is enabled using --spi-user-provider=jpa-encrypted build/start flag");
        }
    }
